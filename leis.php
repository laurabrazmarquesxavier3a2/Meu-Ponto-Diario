            ...
            <div class="col-lg-7 reveal">
                ...
                <div class="search-box mt-4">
                    ...
                    <input
                        ...
                        autocomplete="off"
                        aria-label="Pesquisar uma lei ou assunto"
                    >
...
<section class="section">
    ...
    <div class="container">
            ...
            <article class="faq-card">
                ...
                <div class="faq-answer">
                    ...
                    <div class="faq-answer-content">
                        ...
                        Empresas devem registrar corretamente os horários de
                        entrada, saída, intervalos e jornada dos funcionários,
                        garantindo controle adequado da carga horária.
            ...
            <article class="faq-card">
                ...
                <div class="faq-answer">
                    ...
                    <div class="faq-answer-content">
                        ...
                        Horas trabalhadas além da jornada normal devem ser
                        controladas e compensadas ou remuneradas conforme as
                        regras aplicáveis.
            ...
            <article class="faq-card">
                ...
                <div class="faq-answer">
                    ...
                    <div class="faq-answer-content">
                        ...
                        O banco de horas deve seguir acordo individual ou
                        coletivo, registrando créditos e débitos de jornada
                        de forma clara.
            ...
            <article class="faq-card">
                ...
                >
                    ...
                    <span class="faq-title">
                        ...
                        <span>Intervalo Intrajornada</span>
                ...
                <div class="faq-answer">
                    ...
                    <div class="faq-answer-content">
                        ...
                        O intervalo para descanso e alimentação deve ser
                        respeitado conforme a jornada diária do colaborador.
            ...
            <article class="faq-card">
                ...
                <div class="faq-answer">
                    ...
                    <div class="faq-answer-content">
                        ...
                        Após o período aquisitivo, o colaborador tem direito a
                        férias, que devem ser organizadas e registradas pela
                        empresa.
            ...
            <article class="faq-card">
                ...
                <div class="faq-answer">
                    ...
                    <div class="faq-answer-content">
                        ...
                        Atestados e licenças médicas devem ser enviados pelo
                        colaborador e analisados pelo RH, mantendo registro do
                        período afastado.
            ...
            <article class="faq-card">
                ...
                <div class="faq-answer">
                    ...
                    <div class="faq-answer-content">
                        ...
                        O holerite deve demonstrar salário, descontos,
                        adicionais, benefícios e demais informações referentes
                        ao pagamento.
            ...
            <article class="faq-card">
                ...
                <div class="faq-answer">
                    ...
                    <div class="faq-answer-content">
                        ...
                        Cada empresa deve manter seus próprios registros de
                        funcionários, jornadas, documentos e solicitações de
                        forma separada e segura.
        ...
        <div class="faq-empty" id="faqEmpty">
            ...
            <h3>Nenhum assunto encontrado</h3>
            ...
            <div class="row align-items-center g-4">
                ...
                <div class="col-lg-7">
                    ...
                    <p class="mb-0">
                        ...
                        Acesse a central de ajuda e envie sua dúvida para
                        análise.
