...
(23, NULL, 'Mariana Alves', 'Alves@technova.com.br', '$2y$10$//6b0igvCvXGEFh3Kg919OynR7ze.S0nc.hczpYwFEFVij1sf5OE2', 'rh', 'ativo', '2026-06-11 20:26:34', '2026-06-11 23:26:23', '(11) 97777-2020', 'São Paulo', NULL, 'Gerente de RH', NULL, 5),
...
(29, 26, 'Beatriz Souza', 'beatriz.souza@technova.com.br', '$2y$10$96FidJynG1NOWiBzpZDYQuYSIyvEMIEaHnHUWU7Ujg4mLTRZZfr1u', 'funcionario', 'ativo', NULL, '2026-06-11 23:27:03', '11999996666', 'São Paulo', NULL, 'Analista Financeira', 'Financeiro', 5),
(30, 27, 'Rafael Almeida', 'rafael.almeida@technova.com.br', '$2y$10$X0bNaY20ZnbsW9rmQbxQh.Ed2KliFHyyOVi.N7D5/V85CeivL6PVC', 'funcionario', 'ativo', NULL, '2026-06-11 23:27:03', '11999997777', 'Praia Grande', NULL, 'Coordenador de Suporte', 'Suporte', 5),
...
(38, 35, 'Roberto Lima', 'roberto.lima@technova.com.br', '$2y$10$KxC2WH2fbVvbNWYx8qdge./Z0ohgzU/6aerJqpzUZc0TeqIMJQ/Py', 'funcionario', 'ativo', NULL, '2026-06-11 23:27:04', '11999990007', 'São Paulo', NULL, 'Gerente Financeiro', 'Financeiro', 5),
(39, 36, 'Patricia Nunes', 'patricia.nunes@technova.com.br', '$2y$10$mPqbIy1rs9cSpH/.dZm1Ied8Cwiy8tHPfsyUD5e05oVR5zRzC.L/O', 'funcionario', 'ativo', NULL, '2026-06-11 23:27:04', '11999990008', 'São Paulo', NULL, 'Gerente de Produto', 'Produto', 5),
(40, 37, 'Diego Ribeiro', 'diego.ribeiro@technova.com.br', '$2y$10$On39.XoN0ERFiP0tu4XZu.wZZjatzb.YNqIvVtnYY0oNdNjBGWKF6', 'funcionario', 'ativo', NULL, '2026-06-11 23:27:04', '11999990009', 'Santos', NULL, 'Analista de Dados', 'BI', 5),
(41, 38, 'Isabela Cardoso', 'isabela.cardoso@technova.com.br', '$2y$10$cJoZO4BkuBg1TreB.hHgg.mwSsAc4/3LVn0UptyHWIX5d/SFauDRu', 'funcionario', 'ativo', NULL, '2026-06-11 23:27:04', '11999990010', 'São Paulo', NULL, 'Cientista de Dados', 'BI', 5),
(42, 39, 'Henrique Castro', 'henrique.castro@technova.com.br', '$2y$10$bt5ZX2519qoKeN5uicp.yuCoLDawPmkAfW.uiTfegwvirpDs.JOyu', 'funcionario', 'ativo', NULL, '2026-06-11 23:27:04', '11999990011', 'São Paulo', NULL, 'Coordenador de BI', 'BI', 5),
...
--
ALTER TABLE `pontos`
  MODIFY `id_ponto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=271;
